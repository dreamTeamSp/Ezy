                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if(documentSnapshot.getData() != null){
                            ...
                            for (com.example.ezymobile.cursos inscritos : cursosInscritos){
                                if(inscritos.getTitulo().equals(cursos.get(position).getTitulo())){
                                    holder.btInscrever.setText("Já inscrito");
                                    holder.btInscrever.setEnabled(false);
                                }else{
                                    holder.btInscrever.setText("Cadastrar");
                                    holder.btInscrever.setEnabled(true);
